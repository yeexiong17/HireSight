...
import { ArrowRight, Briefcase, UserCheck, Building } from "lucide-react";
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-8 text-slate-800">
      <div className="max-w-lg w-full">
        {" "}
        {/* Adjusted max-width for a more focused card */}
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-lg text-slate-600">
            Streamline your hiring process with intelligent, AI-powered
            interviews.
          </p>
        </div>
              ...
              >
                ...
                <div className="ml-3 flex items-center">
                  ...
                  <div>
                    ...
                    >
                      Configure interviews & view reports.
                    </p>
                  </div>
                </div>
              </Label>
              ...
              >
                ...
                <div className="ml-3 flex items-center">
                  ...
                  <div>
                    ...
                    >
                      Browse jobs & start your AI interview.
                    </p>
                  </div>
                </div>
              </Label>
